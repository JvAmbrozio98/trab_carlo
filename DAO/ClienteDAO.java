...
public class ClienteDAO {
    ...
    public ClienteModel consultar(int id) throws SQLException {
        // Consulta SQL para buscar os dados do cliente sem retornar os códigos das chaves estrangeiras
        String sql = "SELECT p.PES_NOME, p.PES_FANTASIA, p.PES_CPFCNPJ,p.PES_CADASTRO, c.CLI_LIMITECRED " +
                "FROM pessoa p " +
